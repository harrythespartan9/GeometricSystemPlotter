% (1032378213834938089*sign((a1*cos(2*s*pi) + a2*sin(2*s*pi))/(a1^2 + a2^2)^(1/2))*abs(a1*cos(2*s*pi) + a2*sin(2*s*pi))^20*(a1^2 + a2^2)^(1/2))/(288230376151711744*abs(a1^2 + a2^2)^10)
