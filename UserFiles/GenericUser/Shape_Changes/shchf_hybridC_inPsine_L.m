function output = shchf_diametricallyOpp_SwingAdhesionCoords_sinusoidal_inPhase_L(input_mode,pathnames)
	...
	switch input_mode
		...
		case 'name'
			...
			output = 'Swing Angle and Adhesion: in-phase Loffset, Sinusoidal Alpha, Amp = pi/2';
